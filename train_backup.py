...
if __name__ == "__main__":
    ...
    annotations_train = load_jsonl_file("Fakeddit/annotations/subtask2b/train.tsv")
    ...
    annotations_val = load_jsonl_file("annotations/subtask2b/val.tsv")
    ...
    annotations_test = load_jsonl_file("annotations/subtask2b/dev_unlabeled.tsv")
